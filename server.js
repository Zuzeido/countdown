...
// Función para generar la imagen del contador
function generateCountdownImage(days, hours, minutes, seconds, bgColor = '#000000', textColor = '#FFFFFF') {
  const width = 800;
  const height = 250;
...
&lt;/div&gt;</pre>
        ...
        <div class="example">
          ...
          <ul>
            ...
            <li>✅ Respuesta rápida (PNG optimizado)</li>
          </ul>
        </div>
      </body>
    </html>
...
app.get('/countdown', (req, res) => {
  try {
    ...
    // Generar imagen
    const imageBuffer = generateCountdownImage(days, hours, minutes, seconds, bgColor, textColor);
